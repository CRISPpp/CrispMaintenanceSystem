...
import cn.crisp.crispmaintenanceuser.security.filter.JwtAuthenticationTokenFilter;
import cn.crisp.crispmaintenanceuser.security.handler.AuthenticationEntryPointImpl;
import cn.crisp.crispmaintenanceuser.security.handler.LogoutSuccessHandlerImpl;
...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeRequests()
                //对登录、注册和验证允许匿名访问
                    .antMatchers("/user/login", "/user/register", "/websocket/**").anonymous()
                //静态资源也可以匿名访问
